...
import com.example.SharpCut.Models.Request.EmailRequest;
import com.example.SharpCut.Models.Request.LoginRequest;
import com.example.SharpCut.Models.Request.RegisterRequest;
...
public class AuthenticationController {
    ...
    public ResponseEntity<Map> registerUser(@RequestBody RegisterRequest registerRequest) {
        Map response = this.authenticationService.doRegister(registerRequest.getEmail(), registerRequest.getPassword());
    ...
    public ResponseEntity<Object> forgetPassword(@RequestBody EmailRequest emailRequest) throws ResourceNotFoundException {
